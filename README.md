...
| [**Study Project - Instagram UI Clone**](https://github.com/jonasschen/flutter-instagram-clone) | This project is a mobile application built with Flutter for study and learning purposes. The main goal is to practice Flutter fundamentals and UI development by recreating a clone of Instagram’s interface.| Flutter, Dart |

...
| [**Free PDF Merger**](https://github.com/jonasschen/open-source-pdf-merger) | A simple and efficient Python utility to merge multiple PDF files into a single document using a reliable and lightweight library.| Python, JS |
| [**Study Project - Instagram UI Clone**](https://github.com/jonasschen/react-instagram-clone) | This project is a mobile application built with React for study and learning purposes. The main goal is to practice React fundamentals and UI development by recreating a clone of Instagram’s interface.| React |
